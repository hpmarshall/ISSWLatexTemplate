...
%
%  4 - Follow instructions below and come to Tromsø
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\documentclass[3p,authoryear,times,twocolumn]{./elsarticle_issw2024}
...
\title{INSTRUCTIONS FOR FORMATTING YOUR EXTENDED ABSTRACT
INTERNATIONAL SNOW SCIENCE WORKSHOP 2024, TROMS{\O}, NORWAY}

\author[1]{Guri Snøfonn\corref{complete_address}}
\cortext[complete_address]{Corresponding author address:\\Guri Snøfonn, Institute of Snow Hydrology\\0815 Oslo, Norway; \\tel: ++47 99999999; tel: ++47 111111111;\\ email: gfonn@hyrdo.snow}
\author[2]{Mario Nevoso}
\author[3]{Surfer C. Hoar}

\address[1]{Institute of Snow Hydrology, Oslo, Norway}
\address[2]{Public Road Administration, Lombardi, Italy}
\address[3]{Avalanche Forecasting Centre, BC, Canada}


\begin{abstract}
These instructions are laid out in the same format as is requested for ISSW 2024 conference proceedings. The abstract should be less than 350 words. It can be either the same as your initial short abstracts or you can make changes as you wish, for example include new results you have obtained since your initial submission.
\end{abstract}
...
All ISSW presenters - both oral and poster presenters - are required to submit a paper (maximum 8 pages) that describes their presentation topic in more detail for publication in the ISSW 2024 proceedings. At this ISSW, the conference proceedings will only be published electronically.

%
% ===================================================================================================
\section{MANUSCRIPT DEADLINE}

Manuscripts must be received by \textbf{August 15, 2024}. We cannot guarantee that late papers will be included in the conference line-up and the proceedings publication. Your oral or poster presentation slot is conditional on us receiving your paper by this date.\\
...
Figures and tables should be reduced so that they may be incorporated into the text along with the appropriate pages, with full captions typed in (see Figure \ref{fig:ISSW2024_TROMSO_logo}).\\
...
\begin{figure}[h]
 \centering
 \includegraphics[width=1.\columnwidth]{./ISSW2024_TROMSO_logo}
 \caption{The International Snow Science Workshop (ISSW) 2024 is taking place in Tromsø, Norway.}
    \label{fig:ISSW2024_TROMSO_logo}
\end{figure}
...
If you have used WORD, please also submit the original DOCX-file.\\

%
% ===================================================================================================
\section{QUESTIONS}
%
For questions about formatting and content, please contact \href{mailto:science@issw2024.com}{science@issw2024.com}. % 
...
\bibliography{issw2024_bibliography}

\vspace{0.5em}
\href{https://www.natural-hazards-and-earth-system-sciences.net/submission.html#references}{\underline{References Format}}
