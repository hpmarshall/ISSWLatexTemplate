...
% ===================================================================
% ACCESSIBILITY SETUP FOR WCAG 2.1 LEVEL AA COMPLIANCE
% ===================================================================
% IMPORTANT: LaTeX does not automatically create tagged PDFs.
% You MUST post-process the PDF with Adobe Acrobat Pro to add tags.
%
% Steps to make your PDF WCAG compliant:
%   1. Compile this LaTeX document to PDF
%   2. Open the PDF in Adobe Acrobat Pro (not Reader)
%   3. Go to: Tools > Accessibility > Autotag Document
%   4. Wait for the tagging process to complete
%   5. Go to: Tools > Accessibility > Full Check
%   6. Review and fix any remaining issues
%
% This process takes about 2-5 minutes and creates the structure tree
% needed for screen readers, similar to how Word creates tagged PDFs.
% ===================================================================

% Configure hyperref for basic accessibility metadata
\usepackage[colorlinks=true, urlcolor=blue, linkcolor=red,
            pdfusetitle,unicode=true,pdflang={en-US}]{hyperref}
